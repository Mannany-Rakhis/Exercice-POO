...
print(f"Solde d'Alice après dépôt est : {compte1.solde}€")

compte1.retirer(150.0)
print(f"Solde d'Alice après retrait est : {compte1.solde}€")

compte1.retirer(1200.0)  

compte1.virement(compte2, 300.0)
print(f"Solde d'Alice après virement est : {compte1.solde}€")
print(f"Solde de Bob après virement est : {compte2.solde}€")
